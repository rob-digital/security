...
public class JwtServiceImpl implements JwtService {
    ...
    private static final String SECRET_KEY = "1fa5586bc8c13fda3f487fa1fbd4abf933582031e5642c0a92b5ef895caf86ee";
    public String extractUsername(String token) {
        return extraxtClaim(token, Claims::getSubject);
    }

    public <T> T extraxtClaim(String token, Function<Claims, T> claimsResolver) {
